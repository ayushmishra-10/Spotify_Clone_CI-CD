  ...
  const items =[
    {
      ...
      artist: 'Compilation for simay with ErenYalcn',
...

    {
      id: 2,
      title: 'Arkada Çalsın',
      artist: 'One play button away from the background music.',
    ...
    <div>
        ...
        <div className='grid grid-cols-2 gap-x-4'>
          <div className='h-[296px] bg-gradient-to-r from-gra3 to-gra4 rounded p-6 group relative'>
            <div className='mt-20'>
              <span className='text-sm font-semibold'>Steven Tyler</span> <span className='opacity-70'> • Nevale </span>
              <span className='text-sm font-semibold'>Joe Cocker</span> <span className='opacity-70'> • Süpermen </span>
              <span className='text-sm font-semibold'>İbrahim Tatlıses</span> <span className='opacity-70'> • Tamam Aşkım </span>
              <span className='text-sm font-semibold'>B.B. King</span> <span className='opacity-70'> • Yangınlı Şiir </span>
              <span className='text-sm font-semibold'>Emir Can İğrek</span> <span className='opacity-70'> • Nevale </span>
              <span className='text-sm font-semibold'>Karen Carpenter</span> <span className='opacity-70'> • Nevale </span>
              <span className='text-sm font-semibold'>B.B. King</span> <span className='opacity-70'> • Nevale </span>  
            </div>
            <div>
